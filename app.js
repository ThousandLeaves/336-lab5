...
function getRandomImage(keyword, count) {
    return new Promise (function (resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=a2uJUR6jPuSTB9TwHkFNAqr1kFJbZ8Lh51nqiT53Vsk&featured=true&orientation=landscape&query=${keyword}`;
